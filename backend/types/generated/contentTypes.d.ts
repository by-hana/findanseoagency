...
export interface ApiAgencyAgency extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'SEO agency profiles';
    displayName: 'Agency';
    pluralName: 'agencies';
    singularName: 'agency';
  };
  ...
  attributes: {
    ...
    badgeStyle: Schema.Attribute.Enumeration<
      ['premium', 'niche', 'data-driven', 'premier']
    > &
    ...
    retentionRate: Schema.Attribute.String;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerColumns: Schema.Attribute.JSON;
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'FindAnSEOAgency'>;
    trustBarHeadline: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ctaStyle: Schema.Attribute.Enumeration<['light', 'dark', 'newsletter']> &
    ...
    heroPrimaryButtonLink: Schema.Attribute.String;
    heroPrimaryButtonText: Schema.Attribute.String;
    heroSecondaryButtonLink: Schema.Attribute.String;
    heroSecondaryButtonText: Schema.Attribute.String;
    heroStatDescription: Schema.Attribute.String;
    heroStatLabel: Schema.Attribute.String;
...
export interface ApiServiceCategoryServiceCategory
  ...
  info: {
    description: 'SEO service specializations';
...
export interface ApiTrustPartnerTrustPartner
  extends Struct.CollectionTypeSchema {
  collectionName: 'trust_partners';
  info: {
    description: 'Trust bar partner logos';
    displayName: 'Trust Partner';
    pluralName: 'trust-partners';
    singularName: 'trust-partner';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::trust-partner.trust-partner': ApiTrustPartnerTrustPartner;
